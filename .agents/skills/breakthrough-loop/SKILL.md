...
description: >
  ...
  against an hard-to-fool scoring harness - instead of serial hand-crafted
...
4. Oracle ceiling + trivial/random baseline measured, gap worth mining?
   (Measure BEFORE round 1 - a flat ceiling discovered at round 10 is nine
   rounds of wasted budget.)
